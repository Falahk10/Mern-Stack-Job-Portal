...
const UserProfile = () => {
  ...
  return (
    <div className="w-full dark:bg-slate-800">
      <div className="dark:bg-slate-800 container mx-auto flex items-center justify-center py-10">
        <div className="w-full md:w-2/3 2xl:w-2/4 dark:bg-slate-700 bg-white shadow-lg p-10 pb-20 rounded-lg">
          <div className="flex flex-col items-center justify-center mb-4">
            <h1 className="text-4xl   dark:text-white  font-semibold text-slate-600">
              {userInfo?.firstName + " " + userInfo?.lastName}
            </h1>

            <h5 className="text-blue-700   dark:text-white  text-base font-bold">
            ...
            <div className="w-full flex flex-wrap lg:flex-row justify-between mt-8 text-sm">
              ...
              {userInfo.cv && (
                <a
                  ...
                  href={"http://localhost:8800/" + user?._id + ".pdf"}
                  target="_blank"
                >
                  <GrNotes /> {"View CV"}
                </a>
          ...
          <div className="w-full py-10">
            <div className="w-full flex flex-col-reverse md:flex-row gap-8 py-6">
              <div className="w-full md:w-2/3 flex flex-col gap-4 text-lg text-slate-600 mt-20 md:mt-0">
                <p className="text-[#0536e7]   dark:text-white   font-semibold text-2xl">
                  ABOUT
                </p>
                <span className="text-base   dark:text-white  text-justify leading-7">
              ...
              <div className="w-full  md:w-1/3 h-44">
                ...
                />
                <button
                  className="w-full md:w-40 lg:w-52 bg-blue-600 text-white mt-4 py-2 rounded"
